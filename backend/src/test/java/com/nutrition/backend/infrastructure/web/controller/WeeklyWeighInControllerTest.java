...
class WeeklyWeighInControllerTest {
    ...
    @MockBean
    RecordWeightEntryUseCase recordWeightEntryUseCase;
    ...
    void should_return_all_weighins_when_valid_jwt_is_provided() throws Exception {
        ...
        when(getWeightEntriesUseCase.allByUser(1L)).thenReturn(List.of(w1, w2));
    ...
    void should_return_latest_weighin_when_at_least_one_exists() throws Exception {
        ...
        when(getWeightEntriesUseCase.latestByUser(1L)).thenReturn(Optional.of(latest));
    ...
    void should_return_204_when_no_weighin_has_been_recorded() throws Exception {
        when(getWeightEntriesUseCase.latestByUser(1L)).thenReturn(Optional.empty());
