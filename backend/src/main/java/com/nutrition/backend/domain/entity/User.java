...
public final class User {
    ...
    public User withUsername(String username) {
        return new User(id, username, email, passwordHash, gender, age, height,
                startWeight, currentWeight, dailyCalorieGoal, weightGoal, weighInDay, dailyStepsGoal);
    }
    ...
    public User withBodyMetrics(Gender gender, int age, double height, double currentWeight, String weighInDay) {
        ...
        return new User(id, username, email, passwordHash, gender, age, height,
                startWeight, currentWeight, dailyCalorieGoal, weightGoal, effectiveWeighInDay, dailyStepsGoal);
    }
